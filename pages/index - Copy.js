...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      <main className="  items-center justify-center flex m-6  bg-wh-700 ">
        <form
          onSubmit={formik.handleSubmit}
          className="flex justify-center items-center  rounded-lg  font-latoRegular w-1/2  bg-wh-700 shadow-md "
        >
          <div className="flex flex-col justify-center   text-[#6fbd43] w-full p-10 m-6 bg-white  ">
            <div>
              <h1 className=" text-3xl pb-2 font-latoBold text-left ml-0">
